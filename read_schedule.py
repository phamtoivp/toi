...
def find_work(list_time_schedules, list_link_schedules, current_time):
    j = 0
    for i in range(len(list_link_schedules)):
        ...
        if total_current < total_schedule:
            print(list_link_schedules[i])
...
def main():
    ...
    while True:
        ...
        link_file, time_work = find_work(list_time_schedules, list_link_schedules, current_time)
        os.chdir(link_file)
